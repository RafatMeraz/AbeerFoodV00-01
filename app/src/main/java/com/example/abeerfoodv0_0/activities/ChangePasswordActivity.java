...
import static com.example.abeerfoodv0_0.utils.Constraints.currentUser;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    private void resetPassword() {
        ...
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constraints.UPDATE_PASSWORD,
